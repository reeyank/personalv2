...
export default async function Page() {
  return (
    <div className="mt-4 m-4 lg:flex lg:justify-between">
      <div className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-12 lg:pr-2">
        <div className="lg:flex lg:flex-col lg:flex-1 lg:mt-0 lg:m-0 lg:justify-center lg:text-center">
          ...
          <div>
            <h2 className="text-center">Software Developer, College Student</h2>
            <div className="flex justify-center">
              <a href="https://github.com/reeyank">
